...
- New KV-backed Durable Object namespace restriction: https://developers.cloudflare.com/changelog/post/2026-07-09-restrict-new-kv-backed-namespaces/
...
- Workflows sleeping and retrying (dynamic delay functions and `NonRetryableError`): https://developers.cloudflare.com/workflows/build/sleeping-and-retrying/
...
- Images pricing (binding calls use unique-transformation billing): https://developers.cloudflare.com/images/pricing/
- Images binding billing/cache behavior: https://developers.cloudflare.com/images/optimization/binding/
- Images binding unique-transformation announcement: https://developers.cloudflare.com/changelog/post/2026-07-01-binding-unique-transformations/
...
- DNS proxied records: https://developers.cloudflare.com/dns/proxy-status/
